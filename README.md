...
*   *Бот понимает смысл запросов, что значительно улучшает функцию обнаружения FAQ*
*   *Бот отправляет документацию админам*
*   *Гибкое взаимодейсвие с FAQ через Админ-Панель*
*   + Исправлены мелкие ошибки и недоработки

**РЕШЕННЫЕ ПРОБЛЕМЫ ПРОШЛОГО РЕЛИЗА:**
*   *Невозможность получить расписание на день*
*   *Обнаружение FAQ в запросах не работало*
*   *Отсутствие документации для админов*

**ИЗВЕСТНЫЕ ПРОБЛЕМЫ ЭТОГО РЕЛИЗА:**
